...
export default function WorkShiftsPage() {
  ...
  const SortableHeader = ({ field, children, className = '' }) => (
    <th 
      className={`text-left py-2.5 sm:py-3 px-2.5 sm:px-4 text-xs sm:text-sm font-medium text-gray-500 cursor-pointer hover:text-gray-700 select-none whitespace-nowrap ${className}`}
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-start sm:items-center justify-between gap-3">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Jornadas</h1>
          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="text-right py-2.5 sm:py-3 px-2.5 sm:px-4 text-xs sm:text-sm font-medium text-gray-500">
                  Acciones
                </th>
              </tr>
            </thead>
                  ...
                  >
                    <td className="py-2.5 sm:py-3 px-2.5 sm:px-4">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-[#126D9B] to-[#3B8D7A] flex items-center justify-center flex-shrink-0">
                          {shift.workerPhoto ? (
                            <img
                    ...
                    <td className="py-2.5 sm:py-3 px-2.5 sm:px-4 text-xs sm:text-sm text-gray-600 whitespace-nowrap">
                      {format(new Date(shift.date), "dd/MM/yy", { locale: es })}
                    </td>
                    ...
                    <td className="py-2.5 sm:py-3 px-2.5 sm:px-4 text-xs sm:text-sm text-gray-600 font-medium whitespace-nowrap">
