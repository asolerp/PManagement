...
import { useJobs, useHouses, useCreateJob, useWorkersFirestore, useUpdateJob, useDeleteJob, useAddActivity } from '@/hooks/useFirestore';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createJob.mutateAsync({
        ...
        slaResolutionHours: company?.slaJobResolutionHours ?? 120,
      });
      onCreated();
    } catch (err) {
