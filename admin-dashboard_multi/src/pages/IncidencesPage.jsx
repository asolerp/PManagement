...
import { useIncidences, useHouses, useCreateIncidence, useUpdateIncidence, useDeleteIncidence, useAddActivity, useWorkersFirestore } from '@/hooks/useFirestore';
...
function SlaBadge({ doc, type = 'incidence' }) {
  const info = type === 'incidence' ? getIncidenceSlaStatus(doc) : null;
  if (!info) return null;
  return (
            ...
            {!isEditing ? (
              <>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <SlaBadge doc={incidence} type="incidence" />
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button
          ...
          title="Incidencias en curso sin cambio de estado desde hace varios días"
        >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2 text-xs text-gray-400">
                    ...
                    <SlaBadge doc={inc} type="incidence" />
                    <StaleBadge doc={inc} />
                    {(inc.workers || []).map((w, i) => (
                      <Link
                        key={w.id || i}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createIncidence.mutateAsync({
        ...
        slaResponseHours: company?.slaIncidenceResponseHours ?? 24,
        slaResolutionHours: company?.slaIncidenceResolutionHours ?? 72,
      });
      onCreated();
    } catch (err) {
