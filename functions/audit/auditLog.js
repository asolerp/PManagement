...
const incidences = createAuditHandlers('incidences', 'incidence');
const jobs = createAuditHandlers('jobs', 'job');
const checklists = createAuditHandlers('checklists', 'checklist');

module.exports = {
  auditLogIncidenceCreated: incidences.created,
  auditLogIncidenceUpdated: incidences.updated,
  auditLogIncidenceDeleted: incidences.deleted,
